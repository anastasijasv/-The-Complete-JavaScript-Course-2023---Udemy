...
const description2 = `${myCountry} is in ${myContinent}, and its ${population} million people speak ${language}`;
...
if (population > 33) {
  ...
  console.log(
    `${myCountry}'s population is ${33 - population} million below average`
  );
}
